        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold mb-6">Add Stock In</h1>
                    ...
                    <form method="POST" action="{{ route('stock-in.store') }}">
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Stock In</button>
                        </div>
                    </form>
                </div>
            </div>
