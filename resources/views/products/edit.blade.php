                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('products.update', $product) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="sku" id="sku" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('sku', $product->sku) }}">
                            @error('sku')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="purchase_price" id="purchase_price" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('purchase_price', $product->purchase_price) }}" step="0.01" min="0" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="selling_price" id="selling_price" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('selling_price', $product->selling_price) }}" step="0.01" min="0" required>
                            @error('selling_price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
